...
class LoanApplicationFactory extends Factory
{
    ...
    public function definition(): array
    {
        $factory = [
            ...
            'time_at_current_address_years' => $this->faker->numberBetween(0, 100),
            'time_at_current_address_months' => $this->faker->numberBetween(0, 11),
            ...
            'time_at_employment1_years' => $this->faker->numberBetween(1, 50),
            ...
            'time_at_employment2_years' => $this->faker->optional()->numberBetween(1, 50),
            'time_at_employment2_months' => $this->faker->optional()->numberBetween(1, 11),
