...
export default function Sidebar() {
    ...
    return (
        <aside className="flex">
            ...
            <div className=" w-52 h-screen px-2 py-2 bg-white shadow-md">
                <div className="px-8">
                    <Logo />
                </div>
                ...
                <div className='flex flex-col items-start space-y-8 mt-8'>
                    ...
                    <Link href="#" className={`${route().current('cars.index') ? 'bg-red-100 text-primary' : 'hover:bg-gray-100 text-gray-500'} flex gap-2 p-2 w-full focus:outline-nones transition-colors duration-200 rounded-lg`}>
                        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
                    ...
                    <Link href="#" className={`${route().current('contacts.index') ? 'bg-red-100 text-primary' : 'hover:bg-gray-100 text-gray-500'} flex gap-2 p-2 w-full focus:outline-nones transition-colors duration-200 rounded-lg`}>
                        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
