export default function DeleteButton({ className = '', children, disabled, ...props }) {
    let size = 'py-2'
    ...
    return (
        ...
        >
            {children ? children : <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" strokeWidth="2" stroke="currentColor" className='w-4 h-4 text-white'>
