...
const RoleForm = React.memo(({ role, closeModal }) => {
    ...
    const [disableNewPermissionBtn, setDisableNewPermissionBtn] = useState(true)
    ...
    const handleNameChange = (e) => {
        ...
        if (value === '' || typeof value === 'undefined') {
            ...
            setDisableNewPermissionBtn(true)
        } else {
    ...
    const handleNewPermissionChange = (e) => {
        ...
        if (value === '' || typeof value === 'undefined') {
            ...
            setDisableSaveBtn(true)
            setData('newPermission', value)
            setDisableNewPermissionBtn(false)
        }
    }
            ...
            <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                                ...
                                data.id && <div className="mt-2 w-full">
                                    ...
                                    <div className='flex gap-2'>
                                        ...
                                        <SuccessButton
                                            ...
                                            disabled={disableNewPermissionBtn}
                                            className='btn-sm'
                                        >
                                            Add
                                        </SuccessButton>
                    ...
                    <div className="bg-gray-50 px-4 py-3 gap-2 sm:flex sm:flex-row-reverse sm:px-6">
                        <SaveButton disabled={disableSaveBtn} />
