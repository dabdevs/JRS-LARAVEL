...
export default function CarInfo({ car }) {
    ...
    return (
        <div className="specs h-full w-full md:w-1/2 py-5 lg:py-1 lg:px-10">
            <RevealOnScroll>
                <h2 className="text-2xl font-bold mb-4 hide display-car">{`${car.year} ${car.make} ${car.model}`}</h2>
            </RevealOnScroll>
            ...
            <RevealOnScroll>
                <div className="flex gap-2 hide display-car">
                    ...
                    <Link href={route('get_qualified', car.id)} className="w-1/2 lg:w-auto align-middle flex gap-2 items-center justify-center bg-white text-primary font-bold mt-2 py-1 px-2 lg:py-2 lg:px-4 rounded-lg border-2 border-primary hover:border-white *:transition duration-300">
