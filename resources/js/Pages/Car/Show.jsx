            ...
            <section className="px-4 mx-auto">
                <div className="p-4 rounded-md shadow-sm bg-white text-center sm:ml-4 sm:mt-0 sm:text-left">
                    ...
                    <div className="flex gap-2 justify-end">
                        ...
                        {car.status === 'Published' && <Link href={route('applications.create', car.id)} className='inline-flex gap-2 px-2 py-1 items-center bg-gray-400 border border-transparent rounded-md font-bold text-xs text-white uppercase tracking-widest hover:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-offset-2 transition ease-in-out duration-150'>
                            Create application
                        </Link>}
                    </div>
                </div>
