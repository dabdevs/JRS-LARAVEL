...
class LoanApplicationFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'second_employer_name' => $this->faker->company,
            'second_occupation_rank' => $this->faker->jobTitle,
            'second_employer_address_line_1' => $this->faker->streetAddress,
            'second_employer_address_line_2' => $this->faker->optional()->secondaryAddress,
            'second_employer_apt_unit' => $this->faker->optional()->randomNumber(4),
            'second_employer_city' => $this->faker->city,
            'second_employer_state' => $this->faker->stateAbbr,
            'second_employer_zip_code' => $this->faker->postcode,
            'second_monthly_income' => $this->faker->optional()->randomFloat(2, 0, 2000),
            'second_monthly_income_description' => $this->faker->optional()->sentence,
        ];
    }
}
