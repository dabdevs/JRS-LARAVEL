    ...
    return (
        <div className="specs h-full w-full md:w-1/2 py-5 lg:py-1 lg:px-10">
            ...
            <div className="flex gap-2">
                <a target="_blank" href={`https://wa.me/${phone}?text=${encodeURIComponent(whatsappMessage)}`} className="w-1/2 align-middle flex gap-2 items-center bg-primary text-white font-bold mt-2 py-2 px-4 rounded-lg border-2 border-primary hover:bg-red-800 hover:border-red-800 transition duration-300">
                ...
                <Link href={route('get_qualified', car.id)} className="w-1/2 align-middle flex gap-2 items-center bg-white text-primary font-bold mt-2 py-2 px-4 rounded-lg border-2 border-primary hover:border-white *:transition duration-300">
