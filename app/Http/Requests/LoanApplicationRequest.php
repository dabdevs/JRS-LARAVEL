...
class LoanApplicationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        $rules = [
            ...
            'employment1_rank' => 'exclude_if:employment1_type,Retired|required|string|max:150',
            'employer1_name' => 'exclude_if:employment1_type,Retired|required|string|max:150',
            'employer1_phone' => 'exclude_if:employment1_type,Retired|required|string|max:100',
            'time_at_employment1_years' => 'exclude_if:employment1_type,Retired|required|string',
            'time_at_employment1_months' => 'nullable|string',
            'employer1_address' => 'nullable|string|max:255',
            'employer1_city' => 'exclude_if:employment1_type,Retired|required|string|max:150',
            'employer1_state' => 'exclude_if:employment1_type,Retired|required|string|max:50',
            'employer1_zip_code' => 'exclude_if:employment1_type,Retired|required|string|max:50',
